...
namespace Terminex.Common.Results
{
    ...
    public abstract class Result : IResultWithFactory<Result>
    {
        ...
        public static Result<Nothing> Success() => Result<Nothing>.Success(Nothing.Value);
        public static Result<Nothing> Failure(Error error) => Result<Nothing>.Failure(error);
        public static Result<Nothing> Failure(IEnumerable<Error> errors) => Result<Nothing>.Failure(errors);
        ...
        /// </summary>
        public static Result<Nothing> Combine(params Result[] results)
        {
        ...
        /// <summary>
        /// Преобразует успешный Nothing-результат в результат со значением.
        /// </summary>
        ...
        /// <summary>
        /// Цепочечное преобразование для Nothing-результата.
        /// </summary>
        ...
        public override string ToString() => BuildMessage(error =>
            $"Status: [{IsSuccess}] ErrorCode: [{error.ErrorCode} - {error.ErrorCode}] Info: [{error.Message}]");
    }
}
